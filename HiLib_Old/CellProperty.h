...
public:
	...
	CBackgroundProperty()
		:m_brush(std::make_shared<CBrush>(RGB(127, 140, 141))),//asbestos
...
public:
	CCellProperty()
		...
		:m_spFont(std::make_shared<CFont>(9,L"Arial")),
		m_spPen(std::make_shared<CPen>(PS_SOLID,2,RGB(221,206,188))),
		m_spPenFocused(std::make_shared<CPen>(PS_SOLID, 1, RGB(22, 160, 133))),
		m_spBrBackground(std::make_shared<CBrush>(RGB(250,250,250))),
		m_spBrFocused(std::make_shared<CBrush>(RGB(195,224,226))),
...
public:
	...
	CHeaderProperty():
	  CCellProperty(
		std::make_shared<CFont>(9,L"Arial"),
		std::make_shared<CPen>(PS_SOLID,2,RGB(211,206,188)),
		std::make_shared<CPen>(PS_SOLID, 1, RGB(22, 160, 133)),
		std::make_shared<CBrush>(RGB(232,232,232)),
		...
		m_crTop(RGB(232,232,232)),m_crBottom(RGB(232,232,232)){}
