...
public:
    sheet_xml_wiarchive(std::wistream& is, CSheet* pSheet) :
        boost::archive::xml_wiarchive(boost::archive::xml_wiarchive(is)), m_pSheet(pSheet) {}
...
public:
    sheet_xml_woarchive(std::wostream& os, CSheet* pSheet) :
        boost::archive::xml_woarchive(boost::archive::xml_woarchive(os)), m_pSheet(pSheet) {}
	CSheet* GetSheetPtr(){return m_pSheet;}
};
...
public:
    sheet_bin_iarchive(std::istream& is, CSheet* pSheet) :
        boost::archive::binary_iarchive(is), m_pSheet(pSheet) {}
	CSheet* GetSheetPtr(){return m_pSheet;}
};
/**
 *  sheet_xml_woarchive
...
public:
    sheet_bin_oarchive(std::ostream& os, CSheet* pSheet) :
        boost::archive::binary_oarchive(os), m_pSheet(pSheet) {}
	CSheet* GetSheetPtr(){return m_pSheet;}
};