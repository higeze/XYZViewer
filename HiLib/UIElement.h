...
struct MouseEventArgs:public EventArgs
{
	...
	MouseEventArgs(CWnd* pWnd, UINT uFlags, CPoint pt)
		:EventArgs(pWnd), Flags(uFlags), Point(pt) {}
...
public:
	...
	boost::signals2::signal<void(MouseEventArgs&)> LButtonDblClk;
	...
	virtual void OnLButtonDblClk(MouseEventArgs& e) { LButtonDblClk(e); }
