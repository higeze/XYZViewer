	...
	m_canPostQuit(canPostQuit)
{
	...
	AddMsgHandler(WM_LBUTTONDBLCLK, &COGLChartWnd::OnLButtonDblClk, this);
...
LRESULT COGLChartWnd::OnLButtonDblClk(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	m_spChart->OnLButtonDblClk(MouseEventArgs(this, (UINT)wParam, CPoint((short)LOWORD(lParam), (short)HIWORD(lParam))));
