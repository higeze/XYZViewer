...
void COGLXAxis::PaintAxis(OGLPaintEventArgs& e)
{
	...
	::glColor3ub( pChart->GetChartProperty()->GetAxisProperty()->GetLineProperty()->GetColor().GetR(),
		pChart->GetChartProperty()->GetAxisProperty()->GetLineProperty()->GetColor().GetG(),
		pChart->GetChartProperty()->GetAxisProperty()->GetLineProperty()->GetColor().GetB());
...
void COGLXAxis::PaintTick(OGLPaintEventArgs& e)
{
	...
	::glColor3ub(pChart->GetChartProperty()->GetTickProperty()->GetLineProperty()->GetColor().GetR(),
		pChart->GetChartProperty()->GetTickProperty()->GetLineProperty()->GetColor().GetG(),
		pChart->GetChartProperty()->GetTickProperty()->GetLineProperty()->GetColor().GetB());
...
void COGLXAxis::PaintGrid(OGLPaintEventArgs& e)
{
	...
	::glColor3ub(pChart->GetChartProperty()->GetGridProperty()->GetLineProperty()->GetColor().GetR(),
		pChart->GetChartProperty()->GetGridProperty()->GetLineProperty()->GetColor().GetG(),
		pChart->GetChartProperty()->GetGridProperty()->GetLineProperty()->GetColor().GetB());
